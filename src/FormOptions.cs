...
namespace gInk
{
    public partial class FormOptions : Form
    {
        ...
        private Label[] lbPens = new Label[10];
        private CheckBox[] cbPens = new CheckBox[10];
        private PictureBox[] pboxPens = new PictureBox[10];
        private ComboBox[] comboPensAlpha = new ComboBox[10];
        private ComboBox[] comboPensWidth = new ComboBox[10];
        private Label lbcbPens, lbpboxPens, lbcomboPensAlpha, lbcomboPensWidth;
        ...
        private void FormOptions_Load(object sender, EventArgs e)
        {
            ...
            {
                int top = p * (int)(Height * 0.075) + (int)(Height * 0.09);
                lbPens[p] = new Label();
                lbPens[p].Left = (int)(Width / 500.0 * 60);
                lbPens[p].Width = 80;
                lbPens[p].Top = top;

                cbPens[p] = new CheckBox();
                cbPens[p].Left = (int)(Width / 500.0 * 30);
                cbPens[p].Width = 25;
                cbPens[p].Top = top - 5;
                cbPens[p].Text = "";
                ...
                pboxPens[p].Left = (int)(Width / 500.0 * 145);
                pboxPens[p].Top = top;
                pboxPens[p].Width = 15;
                ...
                comboPensAlpha[p].Left = (int)(Width / 500.0 * 205);
                ...
                comboPensWidth[p].Left = (int)(Width / 500.0 * 330);
            ...
            for (int p = 0; p < Root.MaxPenCount; p++)
            {
                int top = p * (int)(Height * 0.055) + (int)(Height * 0.24);
        ...
        {
            Text = Root.Local.MenuEntryOptions + " - gInk";
            ...
            lbHkClear.Text = Root.Local.ButtonNameClear;
            lbHkEraser.Text = Root.Local.ButtonNameErasor;
            lbHkInkVisible.Text = Root.Local.ButtonNameInkVisible;
            lbHkPan.Text = Root.Local.ButtonNamePan;
            lbHkPointer.Text = Root.Local.ButtonNameMousePointer;
            lbHkRedo.Text = Root.Local.ButtonNameRedo;
            lbHkSnapshot.Text = Root.Local.ButtonNameSnapshot;
            lbHkUndo.Text = Root.Local.ButtonNameUndo;
            lbGlobalHotkey.Text = Root.Local.OptionsHotkeysglobal;
            cbAllowHotkeyInPointer.Text = Root.Local.OptionsHotkeysEnableinpointer;

            //comboCanvasCursor.Items[0] = Root.Local.OptionsGeneralCanvascursorArrow;
            //comboCanvasCursor.Items[1] = Root.Local.OptionsGeneralCanvascursorPentip;
