...
namespace gInk
{
    public partial class FormCollection : Form
	{
		...
		public void ToTransparent()
		{
			...
			SetLayeredWindowAttributes(Handle, 0x00FFFFFF, 1, 0x2);
		}
		...
		{
			UInt32 dwExStyle = GetWindowLong(Handle, -20);
			//SetWindowLong(Handle, -20, (uint)(dwExStyle & ~0x00080000 & ~0x0020));
			SetWindowLong(Handle, -20, (uint)(dwExStyle & ~0x0020));
			//SetWindowPos(Handle, (IntPtr)(-2), 0, 0, 0, 0, 0x0002 | 0x0001 | 0x0010 | 0x0020);

			//dwExStyle = GetWindowLong(Handle, -20);
			//SetWindowLong(Handle, -20, dwExStyle | 0x00080000);
			//SetLayeredWindowAttributes(Handle, 0x00FFFFFF, 1, 0x2);
			//SetWindowPos(Handle, (IntPtr)(-1), 0, 0, 0, 0, 0x0002 | 0x0001 | 0x0020);
		}
